...
class FormulaireDeCC(forms.ModelForm):
    ...
    adresse = forms.CharField(label='Adresse', max_length=50, required=False, widget=forms.Textarea(attrs={
    ...
    code_postal = forms.CharField(label='Code postal', max_length=30, required=False, widget=forms.TextInput(attrs={
